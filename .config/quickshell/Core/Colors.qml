...
Item {
    ...
    property var base16: isDarkThemed ? jsonAdapter.dark.base16 : jsonAdapter.light.base16
    property var palette: jsonAdapter.palette
    ...
    // A structural component to hold the nested md3 and base16 objects
    ...
    property color transparentBg: Qt.rgba(root.bg.r, root.bg.g, root.bg.b, 0.85)
    ...
    property color accent: md3.primary
    property color clockZen: isDarkThemed ? palette.primary90 : palette.primary20
